<?php
// mdc_review_decision.php
// Summary:
// Backend processor for MDC Tier 2 review actions. Accepts index, new status, and reviewer notes,
// updates the JSON file, and sends email notification to admin.

$submissionFile = __DIR__ . '/mdc_tier2_submissions.json';
$logFile = __DIR__ . '/mdc_tier2_review_log.txt';
...
try {
    ...
    $mail->setFrom('metaldrugcomplex@gmail.com', 'MDC Tier 2 Review');
    $mail->addAddress('kunfirm@metaldrug.com');

    $mail->Subject = "Tier 2 Submission Review: $newStatus";
